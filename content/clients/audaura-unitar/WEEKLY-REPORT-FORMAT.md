...
Generated by the unified `/client-report` skill (UNITAR-weekly path), which reads
this file as the canonical format spec. The legacy `/unitar-weekly-report` global
skill is superseded but still produces the same shape.
