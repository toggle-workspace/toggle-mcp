 ...
 * Toggle's digital advertising proposal, prepared for COO. Revision 2.
 *
 * rev2 follows the COO sit-down of 15 September 2026. One budget at RM145,000
 * all in, a kitchen redesign offered as a prize idea, and a client access
 * checklist as the closing slide.
 *
 * IMPORTANT, and the reason this file reads the way it does. The RM145,000 is
 * the total campaign investment: working media plus production plus the Toggle
 * and COO service fee. The media and fee split is deliberately absent from both
 * the slides AND the speaker notes, because notes travel inside the .pptx. No
 * cost per entry, no blended CPM and no per-line ringgit figure appears
 * anywhere in this deck, since any one of them makes the split solvable. The
 * full internal model lives in media-plan-and-findings-rev2-2026-09-15.md.
 *
 * Note also that two separate RM145,000 figures run through this campaign: the
 * contest prize pool and the campaign investment. Never write a bare
 * "RM145,000" in this deck. Always qualify which one is meant.
 *
 * rev0 and rev1 remain in build-deck.js and build-deck-rev1.js.
 *
...
pptx.title = 'Saji x Bulan Bintang - Digital Advertising Proposal - rev2 (2026-09-15)';
...
// =====================================================================
{
  ...
  s.addText('Prepared by Toggle Solutions for COO  ·  Revision 2, 15 September 2026', {
...
// =====================================================================
{
  ...
  cardGrid(s, [
    ...
    },
    {
      no: '04',
      label: 'The budget',
      title: 'RM145,000, all in',
      body: 'Media, production, creative and campaign management, separate from the '
        + 'RM145,000 contest prize pool. It delivers 4,000 entries and 13.9M paid '
        + 'reach before any non paid contribution.',
    },
...
// =====================================================================
{
  ...
  dash(s);
  headline(s, [
    { t: 'The RM145,000 prize pool, ' },
    { t: 'split to make a headline.', accent: true },
  ], 0.62, 0.9, 23);
  standfirst(s,
    'The client budgeted RM145,000 for prizes and that total does not move by a ringgit. This is '
    + 'separate money from the RM145,000 campaign investment later in the deck. What moves is the '
    + 'shape: 40 weekly winners, plus one Golden Ticket worth ten of them.', 1.56, 0.44);
  ...
  footer(s, [
    ...
    + 'RM145,000 on prizes either way.',
  ]);
  s.addNotes(
    ...
    + 'RM145,000. Nothing has been added to the client’s prize budget.\n\n'
    + 'Say this out loud if anyone looks confused: there are two RM145,000 figures in this campaign '
    + 'and they are not the same money. This slide is the prize pool, which the client funds '
    + 'directly. The RM145,000 later in the deck is the campaign investment that covers media, '
    + 'production and management. Total client outlay is RM290,000.\n\n'
...
// =====================================================================
// 14 · Prize idea, the kitchen
// =====================================================================
{
  const s = creamPage();
  dash(s);
  headline(s, [
    { t: 'One prize idea worth ' },
    { t: 'a reaction.', accent: true },
  ], 0.62, 0.9, 24);
  standfirst(s,
    'This is not in the plan and it is not costed into anything. It came out of the 11 September '
    + 'discussion and it is worth putting in front of the client before the mechanic locks in '
    + 'December.', 1.56, 0.4);
  ...
  cardGrid(s, [
    {
      stat: 'The idea',
      statSize: 15,
      label: 'Uncosted, for discussion',
      title: 'Redesign the winner’s kitchen',
      body: 'Saji lives in a kitchen, and a cash prize leaves no trace of that. A redesigned kitchen puts the brand in the one room the product is used in, and the winner lives inside the ad for years.',
    },
    {
      stat: 'The film',
      statSize: 15,
      label: 'Why it earns its keep',
      title: 'It shoots itself',
      body: 'A cheque handover is one photograph. A kitchen reveal is a series: the before, the build, the reaction, and the first Raya meal cooked in it. That is content the campaign has to invent otherwise.',
    },
    {
      stat: 'The catch',
      statSize: 15,
      label: 'What to weigh first',
      title: 'Fewer winners, longer fulfilment',
      body: 'One kitchen costs more than several weekly prizes, so it either converts some of the 40 or it needs new money. Build windows, contractor liability and one very visible winner are all real.',
      labelHot: true,
    },
  ], { y: 2.08, h: 2.5, titleSize: 12 });

  footer(s, [
    { t: 'Our recommendation does not change: ', lead: true },
    '40 weekly winners plus the RM29,000 Golden Ticket. This slide is a question, not a revision.',
  ]);
  s.addNotes(
    'This is the client’s own idea coming back to them. A free kitchen renovation was one of the '
    + 'prize ideas brainstormed in the 11 September discussion with COO, alongside gold hidden in '
    + 'product and the Saji for a year framing. Nestle’s salary for a year campaign, at a RM4M prize '
    + 'pool, was the reference point in that room.\n\n'
    + 'If the client bites there are two funding routes and neither is costed here. Convert a block '
    + 'of the 40 weekly prizes, which holds the prize pool where it is and reduces the winner count. '
    + 'Or bring a kitchen or appliance brand in as a trade sponsor, which keeps the winner count and '
    + 'adds a third logo to manage.\n\n'
    + 'Before it goes any further someone needs a contractor quote range, a build window that '
    + 'finishes before the 17 April fulfilment date, and a view on liability if a build goes wrong '
    + 'inside a winner’s home.\n\n'
    + 'Present it as a question and move on. It is the last slide of the mechanic section and it '
    + 'should not eat the time the media plan needs.',
  );
}

// =====================================================================
// 15 · Divider, the media plan
// =====================================================================
divider('02.', 'The media plan',
  'What we are planning on, what the RM145,000 campaign investment delivers, and where every assumption behind it came from.');

// =====================================================================
// 16 · The planning rate card
// =====================================================================
{
  const s = creamPage();
  dash(s);
...
// =====================================================================
{
  ...
  standfirst(s,
    ...
    + 'Meta carried the digital route. Count TikTok’s 1.22M clicks and it drops to 0.33%. The band '
    + 'is that wide because there has never been a landing page to measure against. We plan on '
    + '3.6%, and the page and the counter are what earn it.', 1.56, 0.6);

  table(s,
    ['LANDING PAGE CONVERSION', 'CONTEST ENTRIES', 'READ'],
    [
      [{ t: '2.0%', bold: true }, '2,222 entries', { t: 'The rate we set before the pop-up was on the table', hot: true }],
      [{ t: '3.0%', bold: true }, '3,333 entries', 'The pop-up working partly'],
      [{ t: '3.6%', bold: true }, { t: '4,000 entries', bold: true }, { t: 'What we plan on, and it is the target exactly', bold: true }],
      [{ t: '4.5%', bold: true }, '5,000 entries', 'Upside if the counter QR converts at the till'],
    ],
    { y: 2.42, colW: [2.5, 2.1, 4.28], rowH: 0.36, fontSize: 9.5 },
  );

  s.addText(
    'Two things move this number and neither existed in 2026. The landing page gives us a click, a '
    + 'pixel and a conversion event the platforms can optimize toward. The pop-up counter puts both '
    + 'receipts in her hand at the moment she is asked to enter, instead of one of them being days '
    + 'old. 3.6% is what those two are worth.',
    {
  ...
  s.addNotes(
    'Where 3.6% comes from. There is no observed rate for a two-receipt entry anywhere in Saji’s own '
    + 'history, and none of the five Malaysian benchmarks required two receipts either, so this is '
    + 'an argued number rather than a measured one. The argument is the two things at the foot of '
    + 'the slide: a landing page with a pixel, and both receipts in hand at the counter.\n\n'
    + 'If anyone pushes on it, the honest answer is that 3.6% sits at the confident end of the band '
    + 'rather than the middle. The 3.0% row is the one to watch. Our job in weeks 1 and 2 is to '
    + 'measure the real rate off the page and tell you which row we are on well before the contest '
    + 'is half over.\n\n'
    + 'Report against the entry target rather than a media metric. Entries are what the client '
    + 'asked for, and entries are what we show them every week.',
  );
}
...
// =====================================================================
{
  ...
  headline(s, [
    { t: 'RM145,000, ' },
    { t: 'and what it delivers.', accent: true },
  ], 0.62, 0.9, 24);
  standfirst(s,
    'The total campaign investment: the media buy, production, creative and campaign management '
    + 'across the full 10 week window. This is separate from the RM145,000 contest prize pool, '
    + 'which the client funds directly.', 1.56, 0.44);

  splitBar(s, [
    { pct: 40, name: 'Contest conversion' },
    { pct: 52, name: 'Video and reach' },
    { pct: 8, name: 'KOL Spark' },
  ], { y: 2.12, h: 0.52 });

  table(s,
    ['DELIVERS', 'AGAINST THE BRIEF', 'VERDICT'],
    [
      [{ t: '4,000 entries', big: true }, 'Target 4,000', 'On target, and the landing page reports it daily'],
      [{ t: '13.9M paid reach', big: true }, 'Target 15M', { t: 'Paid gets 93% there. KOL and on ground close it.', hot: true }],
      [{ t: '15.1M paid views', big: true }, 'Target 40M campaign wide', 'Paid share only, KOL and organic carry the rest'],
      [{ t: '25.7M impressions', big: true }, 'No target set', 'Frequency around 1.85 across the buy'],
    ],
    { y: 3.18, colW: [2.4, 2.6, 3.88], rowH: 0.33, fontSize: 9.5 },
  );
  footer(s, [
    { t: 'What the number covers: ', lead: true },
    'the media buy, the production, the creative and the campaign management, for all 10 weeks. '
    + 'The prize pool sits outside it.',
  ]);
  s.addNotes(
    'One budget rather than a menu. The earlier draft offered two tiers and COO settled on one '
    + 'number on 15 September.\n\n'
    + 'Answer the second row honestly if the client raises it. Paid media gets to 13.9M of the 15M '
    + 'reach KPI. The gap closes with the 30 influencers, both brands’ owned channels, 320 sampling '
    + 'days across 120 outlets, 96 roadshow days across 32 outlets, POSM and on pack codes, the '
    + '150,000 sample packs and the Sampul Raya. This deck treats the 15M the way it already treats '
    + 'the 40M views target, as campaign wide rather than paid only. That is the assumption to get '
    + 'confirmed, and it is question 1 on the closing slide.\n\n'
    + 'The percentages are planning percentages. They move once the campaign is live, because we '
    + 'optimize against real time results rather than against this bar.',
  );
}

// =====================================================================
// 19 · Against the brief
// =====================================================================
{
  const s = creamPage();
  dash(s);
  headline(s, [
    { t: 'Against the brief, ' },
    { t: 'and against 2026.', accent: true },
  ], 0.62, 0.7, 24);
  standfirst(s,
    'The three KPIs the brief names, what this plan puts on paid media, and what the 2026 campaign '
    + 'actually returned.', 1.4, 0.4);

  table(s,
    ['', 'BRIEF TARGET', 'THIS PLAN, PAID', '2026 ACTUAL'],
    [
      ['Contest entries', '4,000', { t: '4,000', bold: true }, '3,765'],
      ['Paid reach', '15M', { t: '13.9M', bold: true }, '13.8M'],
      ['Video views', '40M campaign wide', '15.1M', '38.8M campaign wide'],
      ['Impressions', 'Not set', '25.7M', '51.0M'],
      ['Engagement rate', '3%', '2.3% impr / 4.2% reach', '0.08% impr'],
      ['Entries per 1M reached', 'Not set', { t: '288', bold: true }, '273'],
    ],
    { y: 1.84, colW: [2.26, 2.1, 2.26, 2.26], rowH: 0.32, fontSize: 9 },
  );

  s.addText(
    'Every figure in the plan column is paid media only. It excludes KOL and organic views from the '
    + '30 influencers, both brands’ owned channels, entries walked in from 320 sampling days across '
    + '120 outlets and 96 roadshow days across 32 outlets, POSM and on pack QR codes, the 150,000 '
    + 'sample packs, the Sampul Raya, and earned media. Actual outcomes should land above it.',
    {
  ...
  footer(s, [
    ...
    'paid is the floor, not the ceiling. Everything the campaign earns for free sits on top of this '
    + 'column.',
  ]);
  s.addNotes(
    'The last row is the one to dwell on. Entries per million reached is the metric that fell every '
    + 'year from 2,653 in 2022 to 273 in 2026, and it is the only one that measures whether media is '
    + 'actually producing entries. This plan turns it upward for the first time in five years, to '
    + '288, which is 4,000 entries against 13.9M reached.\n\n'
    + 'It is a modest improvement and it should be presented as one. The point is the direction, not '
    + 'the size. Reversing a five year slide is the whole argument of this proposal.',
  );
}
...
// =====================================================================
{
  ...
  dash(s);
  headline(s, [
    { t: 'Where the weight goes, ' },
    { t: 'by platform and by job.', accent: true },
  ], 0.58, 0.5, 24);
  standfirst(s,
    'Two views of the same allocation. Contest conversion runs on Meta and TikTok only, engagement '
    + 'runs entirely on TikTok Spark Ads because that is where the KOL content lives, and Google '
    + 'carries the brand film.', 1.18, 0.44);

  const tW = (COL_W - 0.3) / 2;
  const tX2 = PAD + tW + 0.3;
  const tY = 2.34;

  caption(s, 'By job', PAD, 2.08, tW, C.brick);
  caption(s, 'By platform', tX2, 2.08, tW, C.purpleMuted);

  table(s,
    ['LINE', 'SHARE'],
    [
      ['Contest conversion', { t: '40%', bold: true }],
      ['Video and reach', { t: '52%', bold: true }],
      ['Engagement, TikTok Spark', { t: '8%', bold: true }],
    ],
    { x: PAD, w: tW, y: tY, colW: [3.0, 1.29], rowH: 0.32, headH: 0.24, fontSize: 9 },
  );

  table(s,
    ['PLATFORM', 'SHARE'],
    [
      ['TikTok', { t: '62%', bold: true }],
      ['Meta', { t: '30%', bold: true }],
      ['Google and YouTube', { t: '8%', bold: true }],
    ],
    { x: tX2, w: tW, y: tY, colW: [3.0, 1.29], rowH: 0.32, headH: 0.24, fontSize: 9 },
  );

  const whyY = 3.62;
  [
    { name: 'TikTok, 62%', body: 'The cheapest view in the market, plus the Spark Ads on KOL content and the cheaper half of the contest buy.', color: C.brick },
    { name: 'Meta, 30%', body: 'The reach KPI and the higher intent half of the contest buy, with Advantage+ and a real pixel behind it.', color: C.purple2 },
    { name: 'Google, 8%', body: 'The 6 minute film and recall among the Balik Kampung Provider. It earns its place, not its volume.', color: C.orangeRule },
  ].forEach((p, i2) => {
    const w = (COL_W - 0.4) / 3;
    const x = PAD + i2 * (w + 0.2);
    s.addShape(pptx.ShapeType.rect, {
      x, y: whyY, w, h: 1.0, fill: { color: C.card }, line: { type: 'none' },
    });
    s.addShape(pptx.ShapeType.rect, {
      x, y: whyY, w: 0.05, h: 1.0, fill: { color: p.color }, line: { type: 'none' },
    });
    s.addText(p.name, {
      x: x + 0.16, y: whyY + 0.11, w: w - 0.32, h: 0.2,
      fontFace: F.body, fontSize: 9.5, bold: true, color: C.purple2, valign: 'top', ...NM,
    });
    s.addText(p.body, {
      x: x + 0.16, y: whyY + 0.34, w: w - 0.32, h: 0.58,
      fontFace: F.body, fontSize: 8.5, color: C.purpleMuted, lineSpacing: 11, valign: 'top', ...NM,
    });
  });

  footer(s, [
    { t: 'Please note: ', lead: true },
    'these are planning percentages. The split moves once the campaign is live, because we optimize '
    + 'against real time results rather than against this table.',
  ], 'alert');

  s.addNotes(
    'Why TikTok takes the majority. In 2025 TikTok turned 11.5M impressions into 7.26M views, a 63% '
    + 'view rate, six times cheaper per view than YouTube, and a contest session costs less there '
    + 'than on Meta. Meta holds the reach KPI, because it delivered 14.17M reach on its own in 2025.\n\n'
    + 'Contest conversion is split evenly between Meta and TikTok, so neither platform is trusted '
    + 'with the whole entry target before we have live data.\n\n'
...
// =====================================================================
{
  ...
  s.addNotes(
    ...
    + 'It is responsive, verified in Chrome at 360, 390 and 1000 pixels, and carries the client’s '
    + 'briefed mechanic with the pop-up as the entry route. It is unchanged from the previous '
    + 'revision, because nothing in this revision touches the entry flow or the prize pool.\n\n'
...
// =====================================================================
{
  ...
  standfirst(s,
    ...
    + 'These are the parts that carry the 3.6% conversion the plan is built on.', 1.5, 0.36);
...
// =====================================================================
{
  ...
  [
    {
      ...
      head: 'CAVEATS',
      items: [
        'Are the 40M views and 15M reach KPIs paid only, or campaign wide? We have assumed campaign wide for both.',
        'What counts as a view, and is engagement measured on impressions or on reach? The same campaign reads 2.3% or 4.2%.',
        'We do not know the 2026 spend, so every CPM behind this plan stays an assumption until you share it.',
        '3.6% landing page conversion is argued, not measured. At 3.0% entries land at 3,333 instead of 4,000.',
        'The pop-up rests on Bulan Bintang agreeing to host a Saji counter in all 14 boutiques. That yes is not ours to give.',
        'Pop-up build, stock, staffing, the mystery gift and the packaging change sit with on-ground, outside this campaign investment.',
        'A Golden Ticket cannot go inside a bottle of oil, and the draw plus the ticket are two games of chance likely needing one permit.',
    ...
    },
    {
      ...
      items: [
        ...
        'Do you accept 40 weekly winners plus one RM29,000 Golden Ticket in place of 50, inside the same prize pool?',
        'Is the kitchen redesign worth pricing, and would it convert weekly prizes or need new money?',
        'Will Bulan Bintang co fund the RM600 baju component of the weekly prize?',
        'Does a Bulan Bintang online purchase qualify, or does entry need a boutique receipt?',
      ],
    },
  ].forEach((col) => {
    s.addShape(pptx.ShapeType.rect, {
  ...
  footer(s, [
    ...
    'the Bulan Bintang yes on the pop-up, and the access list on the next slide. Everything else we '
    + 'can work around.',
  ]);
}

// =====================================================================
// 29 · What we need from you
// =====================================================================
{
  const s = creamPage();
  dash(s);
  headline(s, [
    ...
    { t: 'to start.', accent: true },
  ], 0.62, 0.7, 24);
  standfirst(s,
    'None of this costs money. It is permissions and files, and each one carries a two to three '
    + 'week lead time if it starts late, against a page that has to be live on 15 January.',
  1.4, 0.36);

  const thirdW = (COL_W - GAP * 2) / 3;
  [
    {
      rule: C.brick,
      head: 'PLATFORM ACCESS',
      items: [
        'Meta Business Manager, partner access to the Saji page and the Instagram account',
        'Meta ad account admin, plus the Pixel and Conversions API on the contest domain',
        'TikTok Business Center partner access and TikTok Ads Manager',
        'TikTok Pixel and Events API, plus Spark Ads codes from every KOL',
        'Google Ads account linked to our manager account',
        'YouTube channel manager access, a GA4 property and a Tag Manager container',
      ],
    },
    {
      rule: C.purple2,
      head: 'PAGE, DOMAIN AND DATA',
      items: [
        'The domain or subdomain the contest page will run on',
        'DNS and hosting access, SSL, and a load test window before 15 January',
        'Who owns the entry database, and who is named PDPA data controller',
        'Who verifies receipts, and the turnaround they commit to',
        'Who fulfils prizes: the cash, the product and the Golden Ticket',
      ],
    },
    {
      rule: C.orangeRule,
      head: 'BRAND, PARTNER AND LEGAL',
      items: [
        'Brand asset library, including Kak Ji files and product photography',
        'The qualifying Saji SKU list, and which SKUs carry the Golden Ticket',
        'The Saji x Bulan Bintang lockup, approved by both sides',
        'The Bulan Bintang floor space agreement and their 14 store addresses',
        'Contest permit applicant and filing owner, locked by mid December',
      ],
    },
  ].forEach((col, i) => {
    const x = PAD + i * (thirdW + GAP);
    s.addShape(pptx.ShapeType.rect, {
      x, y: 1.90, w: thirdW, h: 2.84, fill: { color: C.card }, line: { type: 'none' },
    });
    s.addShape(pptx.ShapeType.rect, {
      x, y: 1.90, w: thirdW, h: 0.06, fill: { color: col.rule }, line: { type: 'none' },
    });
    s.addText(col.head, {
      x: x + 0.16, y: 2.08, w: thirdW - 0.32, h: 0.2,
      fontFace: F.body, fontSize: 8.5, bold: true, charSpacing: 0.8, color: col.rule,
      valign: 'top', ...NM,
    });
    s.addText(
      col.items.map((t) => ({
        text: t,
        options: { bullet: { characterCode: '25A1', indent: 13 } },
      })),
      {
        x: x + 0.16, y: 2.34, w: thirdW - 0.32, h: 2.30,
        fontFace: F.body, fontSize: 8, color: C.purple2, lineSpacing: 10.5,
        paraSpaceAfter: 4, valign: 'top', ...NM,
      },
    );
  });

  footer(s, [
    { t: 'The critical path is two items: ', lead: true },
    'pixel access and the domain. Without them the page cannot report a conversion, and without '
    + 'that every measurement argument in this deck stops working.',
  ]);
  s.addNotes(
    'Hand this slide over as a list rather than reading it out. The only two that sit on the '
    + 'critical path are pixel access and the domain, because the landing page cannot report a '
    + 'conversion without them, and the conversion event is what the whole media argument rests on.\n\n'
    + 'Lead times worth naming if asked. Meta and TikTok partner access is usually same week once '
    + 'someone with admin rights acts. Google Ads manager linking needs a client side accept. A '
    + 'YouTube channel on a personal Google account rather than a brand account is the one that '
    + 'quietly takes weeks, so ask early which it is. The Bulan Bintang floor space agreement and '
    + 'the contest permit are the two long poles and both have to be done by mid December.\n\n'
    + 'The checkbox glyphs are there so this can be screenshotted into an email and worked through.',
  );
}
